...
START_TAG = "<START>"
STOP_TAG = "<STOP>"
EMBEDDING_DIM = 6 #由于标签一共有name notional ticker word start end 6个
HIDDEN_DIM = 4#隐藏层的特征数量，因为是双向所以是2倍
...
#         str = str.strip("\n")
#         words = str.split(" ")
#         training_data1.append(words[0])
#         training_data2.append(words[3].split("-")[0])
# f.close()
# word = []
# word.append(training_data1)
# word.append(training_data2)
# niu = tuple(word)
# training_data.append(niu)
